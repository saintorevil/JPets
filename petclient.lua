...
Citizen.CreateThread(function()
    ...
    if Config.CanAttack then
        while true do
            ...
            attacking = false
            if animal ~= nil and not attacking and aimingatentity and IsEntityAPed(entity) and GetEntityHealth(entity) ~= 0 then
                ...
                if IsControlPressed(1, 51) then
                    if entity == animal then
                        ...
                        DrawNotification(true, false)
                    elseif GetEntityModel(animal) == GetEntityModel(entity) then
                        ClearPedTasks(animal)
                        SetNotificationTextEntry("STRING")
